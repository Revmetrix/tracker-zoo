...
$(function () {
  ...
  var App = {
    ...
    render: function () {
      window.tz.common.store('tracker-zoo-segment-cart', this.cart);
      window.tz.common.store('tracker-zoo-segment-user-id', this.userId);
    },
    login: function (e) {
    ...
    quickView: function (productId) {
      ...
      window.tz.common.segmentio_track_pageview(pageTitle);
      this.render();
    },
    ...
    addToCart: function (itemId) {
      ...
      window.tz.common.segmentio_track_pageview(itemName);
      window.tz.common.segmentio_track_add_item(product);
      this.render();
    },
    checkout: function () {
      window.tz.common.segmentio_track_checkout(this.cart);
      this.cart = [];
      this.render();
    },
    home: function () {
      window.tz.common.segmentio_track_pageview('Home');
      this.render();
    }
  };
